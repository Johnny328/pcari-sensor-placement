...
def selTournamentSPEA2(individuals, k):
    def tourn(ind1, ind2):
        if ind1.fitness.spea2 > ind2.fitness.spea2:
            return ind2
        elif ind1.fitness.spea2 < ind2.fitness.spea2:
            return ind1
...
def selSPEA2(individuals, k):
    ...
    for i in chosen_indices:
        individuals[i].fitness.spea2 = fits[i]
...
__all__ = ['selNSGA2', 'selSPEA2', 'sortNondominated', 'sortLogNondominated',
           'selTournamentDCD', 'selTournamentSPEA2']
